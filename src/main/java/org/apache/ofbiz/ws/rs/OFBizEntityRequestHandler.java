...
public class OFBizEntityRequestHandler implements Inflector<ContainerRequestContext, Response>{
	
	private String entityName;
	
	public OFBizEntityRequestHandler(String entityName) {
		this.entityName = entityName;
	}
	
	public OFBizEntityRequestHandler() {
	...
	public Response apply(ContainerRequestContext data) {
		...
		System.out.println("entityName to be invoked "+entityName);
