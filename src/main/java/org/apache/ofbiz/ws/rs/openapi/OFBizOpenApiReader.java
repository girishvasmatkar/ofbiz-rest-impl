...
public class OFBizOpenApiReader implements OpenApiReader {
	...
	public OpenAPI read(Set<Class<?>> classes, Map<String, Object> resources) {
		...
		Tag serviceResourceTag = new Tag().name("Exported Services").description("OFBiz services that are exposed via REST interface with export attribute set to true");
